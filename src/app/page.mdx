...
![](@/images/logo-for-uaecodes.png)

## A Journey into the World of Programming | Youth Council {{ date: '2023-10-24T00:00Z' }}

A three day workshop titled "A Journey into the World of Programming and it's effect on societies" will be held in partnership with the Federal Youth Authority and will be open to join using the following link: [Linktr.ee/emiratesyouth](https://linktr.ee/emiratesyouth) (Arabic)

### <SparkleIcon /> Dates and Locations

- `24th October`: 10:00 AM at Fujairah Creative X Hub
- `25th October`: 10:00 AM at Tamayuz Platform
- `26th October`: 10:00 AM at Fujairah Creative X Hub
